    ...
    <div className="mx-auto max-w-sm px-4 py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2 ">
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          >
            <h3 className="text-2xl font-bold text-black dark:text-white font-cursive ">
              {testimonials[active].name}
            </h3>
            <p className="text-sm text-gray-500 dark:text-neutral-500 font-inter">
              {testimonials[active].designation}
            </p>
            <motion.p className="mt-8 text-lg text-gray-500 dark:text-neutral-300 font-poppins italic">
